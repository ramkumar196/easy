...
<head>
  ...
  <script type="text/javascript" src="{!! asset('admin/js/angular/plugins/alertify.js'); !!}"></script>
  <script type="text/javascript" src="{!! asset('admin/js/angular/dirPagination.js'); !!}"></script>
  ...
  <script type="text/javascript" src="{!! asset('admin/js/angular/plugins/angular-text-setup.js'); !!}"></script>
  ...
  <script type="text/javascript" src="{!! asset('admin/js/angular/plugins/angular-material.min.js'); !!}"></script>
  <script type="text/javascript" src="{!! asset('admin/js/angular/app.js'); !!}"></script>
