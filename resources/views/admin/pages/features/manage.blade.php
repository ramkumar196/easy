...
@section('content')
<div class="row" ng-controller="ManageCategoryController" >
                        <div class="col-md-12">
                                ...
                                <div class=" panel-body form-group">                        
                                       <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" ng-model="search.category_name" class="form-control" placeholder="Keywords">
                                            </div>
                                        </div>    
                                        <div class="col-md-4">
                                            <div class="input-group">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <tr ng-if="filtered.length == 0">
                                                <td colspan="3" class="center"><center>No data</center></td>
                                                </tr> 
                                                <tr ng-if="filtered.length > 0">
                                                    <th width="50">id</th>
                                                    <th>Category Name</th>
                            ...
                            <script type="text/javascript" src="{!! asset('admin/js/angular/managecategory.js'); !!}"></script>
