      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder" >
        ...
        <div id="hero" style="display:none">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            <div class="item" style="background-image: url(frontend/images/sliders/01.jpg);">
            ...
            <div class="item" style="background-image: url(frontend/images/sliders/02.jpg);">
              <div class="container-fluid">
                <div class="caption bg-color txt-white vertical-center text-left">
                  <div class="slider-header fadeInDown-1">Spring 2016</div>
                  <div class="big-text fadeInDown-1"> Electro Sale  </div>
